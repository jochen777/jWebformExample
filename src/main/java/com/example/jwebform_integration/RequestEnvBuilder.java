...
public class RequestEnvBuilder {
  ...
  private RequestEnvBuilder() {
    // private constructor disallows direct instanciation.
  }

  public static Env of(HttpServletRequest request) {
    return new EnvBuilder().of(request::getParameter, // Request
        request.getSession()::getAttribute, // SessionGet
        request.getSession()::setAttribute);
  }

  public static Env ofWithDebugging(HttpServletRequest request) {
